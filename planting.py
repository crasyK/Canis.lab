...
while command != "exit":
    if command == "create":
        ...
        seed_file = input("Enter seed file path: ").strip()
        state_file = start_seed_step(state_file_name, seed_file)
        ...
        print(get_markers(state_file_name))
        output_marker = input("Enter output marker (default 'raw_conversation'): ").strip() or "raw_conversation"
        complete_running_step(state_file_name, output_marker)
        ...
        state_file = add_step(state_file_name, step_name, template_file, in_marker, out_marker)
        ...
        state_file = finalize_conversation_state(state_file_name, in_marker, out_marker)
